    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center" style={{ background: "#020916" }}>
            ...
            <div className={`relative z-10 flex flex-col items-center gap-6 px-6 ${shake ? "animate-shake" : ""}`}
                ...
                <Image src={CLD.footerLogo} alt="X-Ortho" width={340} height={140}
                ...
                <div style={{
                    ...
                    <div style={{ width: "100%", position: "relative" }}>
                        ...
                        />
                        {error && (
                            <p style={{ position: "absolute", bottom: "-22px", left: 0, fontSize: "11px", color: "rgba(255,100,100,0.85)", letterSpacing: "0.05em" }}>
                                Incorrect password
                            </p>
                        )}
                    </div>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto" style={{ background: "#020916" }}>
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-14 py-6 sm:py-8">
                <div className="flex items-center justify-center relative mb-8 sm:mb-10">
                    <button
                        onClick={onBack}
                        className="absolute left-0 font-nexa uppercase tracking-[0.15em] font-bold px-3 py-1.5 rounded-full transition-all"
                    ...
                    >←</button>
                    <Image src={CLD.footerLogo} alt="X-Ortho" width={450} height={200}
                    ...
                    <Image src={CLD.logo} alt="X-ORTHO" width={200} height={200}
                        className="block sm:hidden"
...
function OrbitalShowcase({ products, onItemClick }: {
    ...
    useEffect(() => {
        const update = () => {
            ...
            if (ringRef.current) {
                ...
                ringRef.current.style.top = `${50 - (ry / (ringRef.current.parentElement?.getBoundingClientRect().height || 1)) * 50}%`;
            }
        };
        update();
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Smooth mouse interpolation — removes lag
            ...
            for (let i = 0; i < n; i++) {
                ...
                // Orbital position — front item lands exactly at (0, 0)
                ...
                // Parallax — ONLY on non-front items (depth = 0 at front)
                // This prevents front item from moving & orbital plane from tilting
                const depth = 1 - f;
            ...
            // Pause when new item reaches front
        ...
        <main key={mainKey} className="relative w-full bg-[#020916]" style={{ height: "100vh", overflow: "hidden" }}>
            ...
            <div className="relative z-10 flex flex-col items-center w-full h-full px-4 sm:px-6 lg:px-10" style={{ paddingTop: "clamp(12px,2.5vh,28px)" }}>
                ...
                <div className="cs-footer w-full flex flex-col items-center gap-1 text-center" style={{ paddingBottom: "clamp(14px,2.5vh,32px)" }}>
                    ...
                    <p className="font-nexa text-[13px] sm:text-[14px] uppercase tracking-[0.3em] font-bold" style={{ color: "rgba(255,255,255,0.12)" }}>
                        © {new Date().getFullYear()} X-Ortho · TLC DME LLC
                    </p>
                </div>
